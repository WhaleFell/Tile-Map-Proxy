...
`,Ve=(e,t)=>{let s="";return e.forEach(r=>{s+=`
        ...
        `}),s},Xe=(e,t)=>Pt.replace(`{{%${e}%}}`,t);var q=new R({strict:!1});q.get("/",e=>{let s=new URL(e.req.url).origin;return e.html(Xe("items",Ve(V,s)))});qe(q);q.route("/",Be);q.route("/map",We);var Ze=q;import{Http2ServerRequest as Qe}from"http2";import{Readable as Mt}from"stream";import zt from"crypto";var X=class extends Error{static name="RequestError";constructor(e,t){super(e,t)}},Ot=e=>e instanceof X?e:new X(e.message,{cause:e}),Tt=global.Request,Z=class extends Tt{constructor(e,t){typeof e=="object"&&O in e&&(e=e[O]()),typeof t?.body?.getReader<"u"&&(t.duplex??="half"),super(e,t)}},Ct=(e,t,s,r)=>{let n=[],o=s.rawHeaders;for(let c=0;c<o.length;c+=2){let{[c]:i,[c+1]:l}=o;i.charCodeAt(0)!==58&&n.push([i,l])}let a={method:e,headers:n,signal:r.signal};return e==="GET"||e==="HEAD"||(a.body=Mt.toWeb(s)),new Z(t,a)},O=Symbol("getRequestCache"),jt=Symbol("requestCache"),ye=Symbol("incomingKey"),ge=Symbol("urlKey"),me=Symbol("abortControllerKey"),et=Symbol("getAbortController"),Q={get method(){return this[ye].method||"GET"},get url(){return this[ge]},[et](){return this[O](),this[me]},[O](){return this[me]||=new AbortController,this[jt]||=Ct(this.method,this[ge],this[ye],this[me])}};["body","bodyUsed","cache","credentials","destination","headers","integrity","mode","redirect","referrer","referrerPolicy","signal","keepalive"].forEach(e=>{Object.defineProperty(Q,e,{get(){return this[O]()[e]}})});["arrayBuffer","blob","clone","formData","json","text"].forEach(e=>{Object.defineProperty(Q,e,{value:function(){return this[O]()[e]()}})});Object.setPrototypeOf(Q,Z.prototype);var _t=(e,t)=>{let s=Object.create(Q);s[ye]=e;let r=(e instanceof Qe?e.authority:e.headers.host)||t;if(!r)throw new X("Missing host header");let n=new URL(`${e instanceof Qe||e.socket&&e.socket.encrypted?"https":"http"}://${r}${e.url}`);if(n.hostname.length!==r.length&&n.hostname!==r.replace(/:\d+$/,""))throw new X("Invalid host header");return s[ge]=n.href,s};function we(e,t){if(e.locked)throw new TypeError("ReadableStream is locked.");if(t.destroyed){e.cancel();return}let s=e.getReader();return t.on("close",r),t.on("error",r),s.read().then(o,r),s.closed.finally(()=>{t.off("close",r),t.off("error",r)});function r(a){s.cancel(a).catch(()=>{}),a&&t.destroy(a)}function n(){s.read().then(o,r)}function o({done:a,value:c}){try{if(a)t.end();else if(!t.write(c))t.once("drain",n);else return s.read().then(o,r)}catch(i){r(i)}}}var tt=e=>{let t={},s=[];for(let[r,n]of e)r==="set-cookie"?s.push(n):t[r]=n;return s.length>0&&(t["set-cookie"]=s),t["content-type"]??="text/plain; charset=UTF-8",t},Je=Symbol("responseCache"),I=Symbol("getResponseCache"),U=Symbol("cache"),J=global.Response,T=class rt{#t;#e;[I](){return delete this[U],this[Je]||=new J(this.#t,this.#e)}constructor(t,s){if(this.#t=t,s instanceof rt){let r=s[Je];if(r){this.#e=r,this[I]();return}else this.#e=s.#e}else this.#e=s;if(typeof t=="string"||typeof t?.getReader<"u"){let r=s?.headers||{"content-type":"text/plain; charset=UTF-8"};r instanceof Headers&&(r=tt(r)),this[U]=[s?.status||200,t,r]}}};["body","bodyUsed","headers","ok","redirected","status","statusText","trailers","type","url"].forEach(e=>{Object.defineProperty(T.prototype,e,{get(){return this[I]()[e]}})});["arrayBuffer","blob","clone","formData","json","text"].forEach(e=>{Object.defineProperty(T.prototype,e,{value:function(){return this[I]()[e]()}})});Object.setPrototypeOf(T,J);Object.setPrototypeOf(T.prototype,J.prototype);var be=Reflect.ownKeys(new J).find(e=>typeof e=="symbol"&&e.toString()==="Symbol(state)");be||console.warn("Failed to find Response internal state key");function At(e){if(!be)return;e instanceof T&&(e=e[I]());let t=e[be];return t&&t.body||void 0}var Lt="x-hono-already-sent",qt=global.fetch;typeof global.crypto>"u"&&(global.crypto=zt);global.fetch=(e,t)=>(t={compress:!1,...t},qt(e,t));var It=/^no$/i,Ut=/^(application\/json\b|text\/(?!event-stream\b))/i,Ft=()=>new Response(null,{status:400}),st=e=>new Response(null,{status:e instanceof Error&&(e.name==="TimeoutError"||e.constructor.name==="TimeoutError")?504:500}),xe=(e,t)=>{let s=e instanceof Error?e:new Error("unknown error",{cause:e});s.code==="ERR_STREAM_PREMATURE_CLOSE"?console.info("The user aborted a request."):(console.error(e),t.headersSent||t.writeHead(500,{"Content-Type":"text/plain"}),t.end(`Error: ${s.message}`),t.destroy(s))},nt=(e,t)=>{let[s,r,n]=e[U];if(typeof r=="string")n["Content-Length"]=Buffer.byteLength(r),t.writeHead(s,n),t.end(r);else return t.writeHead(s,n),we(r,t)?.catch(o=>xe(o,t))},Dt=async(e,t,s={})=>{if(e instanceof Promise)if(s.errorHandler)try{e=await e}catch(o){let a=await s.errorHandler(o);if(!a)return;e=a}else e=await e.catch(st);if(U in e)return nt(e,t);let r=tt(e.headers),n=At(e);if(n)n.length&&(r["content-length"]=n.length),t.writeHead(e.status,r),typeof n.source=="string"||n.source instanceof Uint8Array?t.end(n.source):n.source instanceof Blob?t.end(new Uint8Array(await n.source.arrayBuffer())):await we(n.stream,t);else if(e.body){let{"transfer-encoding":o,"content-encoding":a,"content-length":c,"x-accel-buffering":i,"content-type":l}=r;if(o||a||c||i&&It.test(i)||!Ut.test(l))t.writeHead(e.status,r),await we(e.body,t);else{let h=await e.arrayBuffer();r["content-length"]=h.byteLength,t.writeHead(e.status,r),t.end(new Uint8Array(h))}}else r[Lt]||(t.writeHead(e.status,r),t.end())},Bt=(e,t={})=>(t.overrideGlobalObjects!==!1&&global.Request!==Z&&(Object.defineProperty(global,"Request",{value:Z}),Object.defineProperty(global,"Response",{value:T})),async(s,r)=>{let n,o;try{if(o=_t(s,t.hostname),r.on("close",()=>{s.destroyed&&o[et]().abort()}),n=e(o,{incoming:s,outgoing:r}),U in n)return nt(n,r)}catch(a){if(n)return xe(a,r);if(t.errorHandler){if(n=await t.errorHandler(o?a:Ot(a)),!n)return}else o?n=st(a):n=Ft()}try{return Dt(n,r,t)}catch(a){return xe(a,r)}}),ot=e=>Bt(e.fetch);var Xs={supportsResponseStreaming:!0,runtime:"nodejs"},Zs=ot(Ze);export{Xs as config,Zs as default};
