import { newCustomHeaderHandle, OSMTansportMapHandler, newRefererMapHandle, redirectMapHandle, baiduMapHandler } from './mapHandlers'
...
export const MapSourceList: Array<MapSource> = [
	...
	},
	{
		...
		url: 'https://backend.navionics.com/tile/${z}/${x}/${y}?LAYERS=config_1_20.00_0&TRANSPARENT=FALSE&UGC=TRUE&theme=0&navtoken=eyJrZXkiOiJOQVZJT05JQ1NfV0VCQVBQX1AwMSIsImtleURvbWFpbiI6IndlYmFwcC5uYXZpb25pY3MuY29tIiwicmVmZXJlciI6IndlYmFwcC5uYXZpb25pY3MuY29tIiwicmFuZG9tIjoxNzE2MzQ4MDUzMzk2fQ',
	...
	// 	type: 'bing_satelite',
	// 	url: 'http://ecn.dynamic.t${serverpart}.tiles.virtualearth.net/comp/ch/${x}${y}${z}{4}?mkt=en-us&it=A&shading=hill&n=z&cb=1',
	// },
	{
		name: 'Test Router',
		type: 't',
